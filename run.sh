...
do
    ...
    do
        ...
        do
            cd data
            python ../dataset_convert.py -dataset house -id 0 -mr $mr -size $sample_size -func load
            ...
            python ../dataset_convert.py -dataset house -id 0 -mr $mr -size $sample_size -func convert
            ...
            python ./show_tables.py -dataset $dataset -output ../metrics/${model_name}_${mr}_${sample_size}_${depth_list[$d_i]}_${lr_list[$lr_i]}_${l2reg[$l2_i]}
            echo 'finish'
            cd ../vaeac/
        done
    done
